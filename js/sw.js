...
const CACHE_NAME = 'brandmeister-monitor-v0.9.1'; // Increment this when you make changes
const urlsToCache = [
    '/',
    '/index.html',
...
self.addEventListener('install', (event) => {
    console.log('PWA: Installing service worker v0.9.1');
    event.waitUntil(
...
self.addEventListener('activate', (event) => {
    console.log('PWA: Activating service worker v0.9.1');
    event.waitUntil(
