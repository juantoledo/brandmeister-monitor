...
const CACHE_NAME = 'brandmeister-monitor-v0.13.10'; // Increment this when you make changes
const urlsToCache = [
    '/',
    '/index.html',
...
self.addEventListener('install', (event) => {
    console.log('PWA: Installing service worker v0.13.10');
    event.waitUntil(
...
self.addEventListener('activate', (event) => {
    console.log('PWA: Activating service worker v0.13.10');
    event.waitUntil(
